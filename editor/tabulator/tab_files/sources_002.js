 ...
 * 
 * SVN ID: $Id: sources.js 2333 2006-11-05 16:38:26Z timbl $
 *
 ************************************************************/
...
function SourceFetcher(store, timeout, async) {
	...
	sf.mediatypes['application/xhtml+xml'] = {'q': 0.9}
    }
	...
	sf.mediatypes['text/xml'] = {'q': 0.8}
	sf.mediatypes['application/xml'] = {'q': 0.8}
    }
	...
	this.recv = function (xhr) {
		...
		// We give up
		sf.failFetch(xhr, "unparseable - not visibly XML")
	    }
	}
    }
