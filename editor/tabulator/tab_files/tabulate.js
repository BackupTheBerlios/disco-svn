...
//
// SVN ID: $Id: tabulate.js 2284 2006-10-25 10:13:07Z dsheets $
//
...
Icon.tooltips[Icon.src.icon_remove_node]='Remove node from list.'
Icon.tooltips[Icon.src.icon_expand]='Expand this node to view all statements about it.'
Icon.tooltips[Icon.src.icon_collapse] = 'Collapse this node.'
Icon.tooltips[Icon.src.icon_rows] = ''
...
Icon.tooltips[Icon.src.icon_requested] = 'This resource is being fetched. Please wait...'
...
function AJAR_handleNewTerm(kb, p, requestedBy) {
    ...
    if (p.uri.indexOf('#') < 0) {
	    ...
	    // should give HTTP 303 to ontology
...

			...
			return function(display){
			    // empty small
			    small.innerHTML = '';
			    small.appendChild(document.createTextNode((display == 'none') ? (k-dups-n) + ' more' : 'collapse'));
